...
class EmojiMatch {
    ...
    var themes: [String: Theme] = [
        ...
        "People": Theme(emojiList: ["👶", "💂‍♀️", "👩‍🚀", "👩‍✈️", "🧙‍♂️", "💃", "🧖‍♀️", "🎅", "👨‍🏫", "👩‍🍳"], backgroundColor: #colorLiteral(red: 0.5787474513, green: 0.3215198815, blue: 0, alpha: 1), cardColor: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)),
